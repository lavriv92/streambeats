...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'uploads_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Image.thumbnail'
        db.alter_column(u'uploads_image', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Image.image'
        db.alter_column(u'uploads_image', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Image.thumbnail'
        db.alter_column(u'uploads_image', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
